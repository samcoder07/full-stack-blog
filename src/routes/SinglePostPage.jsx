      ...
      <div className="flex gap-8">
        <div className="lg:w-3/5 flex flex-col gap-8">
          <h1 className="text-xl md:text-3xl xl:text-4xl 2xl:text-5xl font-semibold">
            ...
            corporis velit voluptate perferendis incidunt.
          </h1>
          <div className="flex items-center gap-2 text-gray-400 text-sm">
            <span>Written by</span>
            <Link className="text-blue-800">Samarth</Link>
            <span>on</span>
          ...
          <p className="text-gray-500 font-medium">
            ...
            vel vero sed? Magni esse iusto quaerat eos at totam voluptas
            incidunt quia eaque itaque, fuga excepturi iure a necessitatibus
            consequuntur!
          </p>
        </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-8">
              <Image
                ...
                h="48"
              />
              <Link className="text-blue-800">Samarth Saluja</Link>
            </div>
